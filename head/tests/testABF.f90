!$Id: testABF.f90 71 2015-03-25 15:33:10Z mexas $

!*robodoc*u* tests/testABF
!  NAME
!    testABF
!  SYNOPSIS
...
!  PURPOSE
!    Checking: cgca_gbf1f, cgca_cgvgp_nocosum (no CO_SUM version)
!  DESCRIPTION
!    Checking grain boundary fracture propagation for a several
!    iterations *after* all cleavage iterations. Fixed model
!    BC used.
!  AUTHOR
!    Anton Shterenlikht
!  COPYRIGHT
