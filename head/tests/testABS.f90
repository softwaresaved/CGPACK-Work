!$Id: testABS.f90 71 2015-03-25 15:33:10Z mexas $

!*robodoc*u* tests/testABS
!  NAME
!    testABS
!  SYNOPSIS
...
!              cgca_clvgsd, dumping
!    crack state at regular intervals to make crack growth
!    animation.
!  DESCRIPTION
!    Checking cleavage propagation across grain boundary
!    with many grains. Grain boundaries are initiated before
!    cleavage. A single crack nucleus in the middle of x3=0 face.
!  NOTE
