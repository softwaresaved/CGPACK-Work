!$Id: testAAW.f90 71 2015-03-25 15:33:10Z mexas $

!*robodoc*u* tests/testAAW
!  NAME
!    testAAW
!  SYNOPSIS
...
!    in the middle of image 1. Single grain with  random rotation tensor.
!    1-2 cleavage increments. Halo exchange, so cleavage propagation
