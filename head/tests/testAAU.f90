!$Id: testAAU.f90 71 2015-03-25 15:33:10Z mexas $
...
!  DESCRIPTION
!    Checking deterministic cleavage propagation with 1 cleavage nucleus
!    in the middle of image 1. Single grain with a  random rotation tensor.
!    Single cleavage increment.
...
call cgca_clvgp_nocosum( space, grt, t, scrit, cgca_clvgsd, .false.,   &
                         1, 1, yesdebug )
