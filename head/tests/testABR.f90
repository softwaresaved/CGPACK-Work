!$Id: testABR.f90 71 2015-03-25 15:33:10Z mexas $

!*robodoc*u* tests/testABR
!  NAME
!    testABR
!  SYNOPSIS
...
!    with many grains. Grain boundaries are initiated before
!    cleavage. The intention is to compare with test ABB, to
!    see if explicit GB make any difference.
!    Put a single crack nucleus at the centre of one
!    of the faces of the model.
!  NOTE
...
if (image1) then
  ...
  write (*,'(a,i0)') "Max recommended nuclei ", int(resolution*mcells)
