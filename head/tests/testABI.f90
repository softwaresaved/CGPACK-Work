!$Id: testABI.f90 8 2014-12-01 09:13:54Z mexas $

!*robodoc*u* tests/testABI
!  NAME
!    testABI
!  SYNOPSIS
...
!    solidification of the whole model is done with a divide and
!    conquer algorithm, cgca_redall, which does a collective AND
!    reduction over a logical array.
!  NOTE
!    This is timing test only. Use testABH to check the correctness of
!    cgca_sld2.
!  AUTHOR
!    Anton Shterenlikht
!  COPYRIGHT
