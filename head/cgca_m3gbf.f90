!$Id: cgca_m3gbf.f90 14 2014-12-01 10:14:16Z mexas $
...
integer(kind=iarr) :: range1(3), range2(3), range3(3)
...
if (.not. allocated(array)) &
 allocate(array(lbv(1):ubv(1),lbv(2):ubv(2),lbv(3):ubv(3)),stat=errstat)
if (errstat.ne.0) then
 write (*,'(a,i0)') "ERROR: cgca_gbf1f: image ",thisimage
 write (*,'(a)') "ERROR: cgca_gbf1f: cannot allocate array"
 error stop
end if
